...
function CategoryList({ permission }) {
  ...
  //       AxiosInstancePaths.Categories.DELETE_BY_ID + id
  //     );
  ...
  const downloadExcel = async () => {
    try {
      ...
      const response = await axiosInstance.get(AxiosInstancePaths.Categories.DOWNLOAD_EXCEL, {
  ...
  return (
    <div>
      <TableHeaderPart
        addText={permission?.can_add ? "Add Category" : null}
        title="Categories"
