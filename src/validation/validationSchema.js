...
export const ProductSchema = yup.object().shape({
  ...
  gst_percent: yup.number().min(0).required(),
  ...
  base_unit: yup.string().oneOf(["GM", "ML", "KG", "LTR", "EACH"]).required(),
...
export const UpdateProductSchema = yup.object().shape({
  ...
  is_active: yup.boolean(),
  is_featured: yup.boolean(),
  base_unit: yup.string().oneOf(["GM", "ML", "KG", "LTR", "EACH"]),
  grn_date: yup.date().nullable(),
  lot_no: yup.string().nullable(),
  vendor_name: yup.string().nullable(),
});
